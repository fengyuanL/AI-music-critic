...
alldata = {}
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1910_test0.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)

with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1910_test1.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1910_test2.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1910_test3.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1910_test4.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)

with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1910_test5.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)

with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1910_test6.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)

with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1910_test7.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
