...
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1820_valid0.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1820_valid1.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1820_valid2.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1820_valid3.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1820_valid4.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1820_valid5.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1820_valid6.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
   
with open('/Users/graceli/Desktop/MIDI-BERTFT/Data/CP_data/GMP_1820_valid7.json') as json_file:
   data = json.load(json_file)
   alldata.update(data)
