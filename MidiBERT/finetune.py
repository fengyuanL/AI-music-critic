...
def get_args():
    ...
    ### mode ###
    parser.add_argument('--task', choices=['melody', 'velocity', 'composer', 'emotion', 'acclaimed'], required=True)
    ### path setup ###
    ...
    parser.add_argument("--datasets", type=str, default='GMP_1960')
...
def main():
    ...
    test_loader = DataLoader(testset, batch_size=int(args.batch_size/1), num_workers=args.num_workers)
    ...
    with open(os.path.join(save_dir, 'log'), 'a') as outfile:
        ...
        for epoch in range(args.epochs):
            train_loss, train_acc, train_accl, train_accr, train_acclf, train_acclt, train_type1, train_type2 = trainer.train()
            ...
            outfile.write('Epoch {}: train_loss={}, valid_loss={}, test_loss={}, train_acc={}, valid_acc={}, test_acc={}, train_accl={}, valid_accl={}, test_accl={}, train_accr={}, valid_accr={}, test_accr={}, train_acclf={}, valid_acclf={}, test_acclf={}, train_acclt={}, valid_acclt={}, test_acclt={}, train_type1={}, train_type2={}, valid_type1={}, valid_type2={}, test_type1={}, test_type2={}\n'.format(epoch+1, train_loss, valid_loss, test_loss, train_acc, valid_acc, test_acc, train_accl, valid_accl, test_accl, train_accr, valid_accr, test_accr, train_acclf, valid_acclf, test_acclf, train_acclt, valid_acclt, test_acclt, train_type1, train_type2, valid_type1, valid_type2, test_type1, test_type2))
