...
def get_args():
    ...
    ### pre-train dataset ###
    # parser.add_argument("--datasets", type=str, nargs='+', default=['pop909','composer', 'pop1k7', 'ASAP', 'emopia', 'GMP', 'GMP_mini'])
    ...
    parser.add_argument('--accum_grad', type=int, default=16, help='accumulated gradient, number of steps before optim.step')
...
def main():
    ...
    valid_loader = DataLoader(validset, batch_size=int(args.batch_size/2), num_workers=args.num_workers)
    ...
    trainer = BERTTrainer(midibert, train_loader, valid_loader, args.lr, args.batch_size, args.max_seq_len,
    ...
    for epoch in range(args.epochs):
        ...
        trainer.save_checkpoint(epoch, best_acc, 0,
                                0, train_loss, False, filename)
