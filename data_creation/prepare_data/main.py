...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, choices=["pop909", "pop1k7", "ASAP", "pianist8", "emopia", "GMP", "GMP_mini", "GMP_1960", "GMP_Post1960"])
    ...
    if args.task == 'acclaimed' and (args.dataset != 'GMP' or args.dataset != 'GMP_mini' or args.dataset != 'GMP_1960' or args.dataset != 'GMP_Post1960'):
...
def extract(files, args, model, mode=''):
    ...
    if args.input_dir != '' or args.input_file != '':
        ...
        output_file = os.path.join(args.output_dir, f'{args.name}.npy')
            ...
            or dataset == 'GMP_mini' or dataset == 'GMP_1960' or dataset == 'GMP_Post1960':
...
def main():
    ...
    if args.dataset in {'pop909', 'emopia', 'pianist8', 'GMP', 'GMP_mini', 'GMP_1960', 'GMP_Post1960'}:
